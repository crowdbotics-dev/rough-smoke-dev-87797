"""
Django settings for rough_smoke_dev_87797 project.
...
ROOT_URLCONF = 'rough_smoke_dev_87797.urls'
...
WSGI_APPLICATION = 'rough_smoke_dev_87797.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rough_smoke_dev_87797 API",
    "DESCRIPTION": "API documentation for rough_smoke_dev_87797 App",
    "VERSION": "v1",
}
